        ...
        child: Column(
          ...
          children: [
            ...
            _buildSection(
              '환경 변수',
              [
                _buildInfoRow('초기화 상태', EnvConfig.isInitialized ? '완료' : '실패'),
                _buildInfoRow('앱 이름', AppConfig.appName),
                _buildInfoRow('앱 설명', AppConfig.appDescription),
                _buildInfoRow('백엔드 URL', AppConfig.baseUrl),
                _buildInfoRow('카카오 리다이렉트 URI', AppConfig.kakaoRedirectUri),
                _buildInfoRow('로컬호스트 URL', AppConfig.localhostUrl),
                _buildInfoRow('카카오 네이티브 앱 키', '${AppConfig.kakaoNativeAppKey.substring(0, 8)}...'),
                _buildInfoRow('카카오 REST API 키', '${AppConfig.kakaoRestApiKey.substring(0, 8)}...'),
              ],
            ),
            ...
            ElevatedButton(
              onPressed: () {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(content: Text('환경 변수 정보가 콘솔에 출력되었습니다')),
                );
              },
              style: ElevatedButton.styleFrom(
