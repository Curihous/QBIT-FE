...
void main() async {
  ...
  runApp(const QbitWebApp());
}

class QbitWebApp extends StatefulWidget {
  const QbitWebApp({super.key});

  @override
  State<QbitWebApp> createState() => _QbitWebAppState();
}

class _QbitWebAppState extends State<QbitWebApp> {
