...
class AppColors {
  ...
  // Secondary Colors
  static const Color secondaryMain = Color(0xFFFFE19C); 
  static const Color secondaryLight = Color(0xFFFCE6B3); 
  static const Color secondaryBG = Color(0xFFFFFBF3); 
  
  // Chart Colors
  static const Color chartRed = Color(0xFFE74C3C); 
  static const Color chartBlue = Color(0xFF178EDE);
  
  // Order Book Bar Colors
  static const Color orderBookBidBg = Color(0x33178EDE); // chartBlue with opacity
  static const Color orderBookAskBg = Color(0x33E74C3C); // chartRed with opacity
}
...
class AppBorderRadius {
  static const double xs = 4.0;
  static const double sm = 8.0; // 보통 이걸로 다 통일
